...
General writing standards for any text that lands on a Turing Works slide. This file covers *what to say and how to say it*. See `brand.md` for *how it should look* and `deck-playbook.md` for *how to approach the deck as a whole*.
